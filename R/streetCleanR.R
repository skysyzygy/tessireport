...
#'
#' @usage new_streetCleanR(x=new.env())
...
#' @export
input.streetCleanR = function(self) {
  ...
  self$addressStream = subset.ffdf(addressStreamFull,timestamp>lubridate::today()-lubridate::ddays(14) &
                     primary_ind=='y') %>%
  as.ram2 %>% setDT
...
#'
#' @export
process.streetCleanR = function(self) {
  addressStream = self$addressStream
