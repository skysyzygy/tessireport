...
test_that("save_model serializes a model to a cache dir and syncs it", {
  ...
  expect_file_exists(cache_path("test_model/test.model","deep","model"))
  expect_failure(expect_file_exists(cache_path("test_model/test.model","shallow","model")))

  save_model(model, "test_model", sync = T)
  expect_file_exists(cache_path("test_model/test.model","shallow","model"))
  expect_file_exists(cache_path("test_model/test.model","deep","model"))
